...
void testesOrdenacoes() {
    ...
    shuffle( dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );
    heapSort( dados, TAMANHO_ARRAY_ORDENACAO );
    // ou => sort( &heapSort, dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );
    ...
    shuffle( dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );
    shellSort( dados, TAMANHO_ARRAY_ORDENACAO );
    // ou => sort( &shellSort, dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );

    printf( "\nBinary Tree Sort:\n" );
    shuffle( dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );
    binaryTreeSort( dados, TAMANHO_ARRAY_ORDENACAO );
    // ou => sort( &binaryTreeSort, dados, TAMANHO_ARRAY_ORDENACAO );
    imprimir( dados, TAMANHO_ARRAY_ORDENACAO );
